...
export const Cell = memo(function Cell({
  ...
  const getClassName = () => {
    ...
    const base =
      'w-[clamp(38px,8.8vw,44px)] h-[clamp(38px,8.8vw,44px)] sm:w-9 sm:h-9 md:w-10 md:h-10 border relative transition-all duration-100 select-none overflow-hidden touch-manipulation';
