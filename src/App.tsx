...
function App() {
  ...
  return (
    <>
      ...
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:fixed focus:top-2 focus:left-2 focus:z-[200] focus:px-4 focus:py-2 focus:rounded focus:text-sm focus:font-mono-crt focus:text-green-300 focus:metal-panel"
      >
